...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const langUA = {
      ...
      services: {
        ...
        itemTitle: ["Мультиплікатори росту", "Декомпозиція завдань", "Масштабувані проекти", "Digital-системи", "AI-автоматизації", "BI аналітика"],
        descr: ["Доступ до екосистеми спільноти моделей-мультиплікаторів, інтегрованих в CRM, які дозволяють масштабувати результат, використовуючи ефект важеля в digital-процесах.", "Спільнота декомпозує завдання, структуруючи їх на послідовні етапи, що забезпечує прозорість робочих процесів та прискорює досягнення цільових результатів. ", "Спільнота розвиває релевантні діджитал-проєкти з високим профітом. Учасники впроваджують ефективні моделі та досягають стійких результатів.", "Діджитал-інструменти для ефективного управління проєктами: діджиталізація процесів, інтеграція даних та системна координація автоворонок.", "Спільнота створює автономних AI-агентів, об'єднуючи їх в ефективні воркфлоу-процеси для вирішення робочих завдань і масштабування результату.", "Доступ до перевірених аналітичних рішень, ефективних методологій та інструментів для швидкого аналізу даних і системного управління проєктами."]
      },
      format: {
        circleText: 'Формат',
  ...
  const langENG = {
    ...
    services: {
        ...
        itemTitle: ["Growth multipliers", "Task decomposition", "Scalable projects", "Digital systems", "AI automation", "BI analytics"],
        descr: ["Access to an ecosystem of influencer models integrated into CRM, allowing you to scale results using leverage in digital processes.", "The community breaks down tasks into sequential stages, ensuring transparency of work processes and accelerating the achievement of target results.", "The community develops relevant digital projects with high profits. Participants implement effective models and achieve sustainable results.", "Digital tools for effective project management: process digitization, data integration, and systematic coordination of autofunnels.  ", "The community creates autonomous AI agents, combining them into effective workflow processes to solve work tasks and scale results.", "Access to proven analytical solutions, effective methodologies, and tools for rapid data analysis and systematic project management."]
    },
    format: {
        circleText: 'Format',
        title: 'Mannequin',
        titleSecondLine: 'GTM systems',
        cornerText: 'Progressive growth practices',
        blockFirst: 'The community implements mannequin GTM projects that are developed within the framework of a single strategic model. Each project is part of the overall GTM architecture and is adapted to target segments for scalable growth.',
        blockSecond: "Positioning, communications, and funnels are managed centrally.",
        blockThird: "Community projects focus on scaling mannequin-making processes and building an effective systematic approach.",
        blockFourth: 'Go-to-Model processes are being implemented within the community to help increase project profitability. Particular attention is paid to the development of BI systems that ensure scalability and stable management at every stage of growth.'
    },
    // tarifs: {
    //     title: 'Tariffs',
